 ...
 */
package org.ambient.flink.streaming.connectors.redis.common.mapper;

import org.ambient.flink.streaming.connectors.redis.RedisSinkCommandsTest;
...
public class RedisDataTypeDescriptionTest extends TestLogger {
	...
	public void shouldThrowExceptionIfAdditionalKeyIsNotGivenForHashDataType(){
		RedisSinkCommandsTest.RedisCommandMapper redisCommandMapper = new RedisSinkCommandsTest.RedisCommandMapper(RedisCommand.HSET);
		redisCommandMapper.getCommandDescription();
	}

	@Test
	public void shouldReturnNullForAdditionalDataType(){
		RedisSinkCommandsTest.RedisCommandMapper redisCommandMapper = new RedisSinkCommandsTest.RedisCommandMapper(RedisCommand.LPUSH);
